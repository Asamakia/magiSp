...
**完了条件（各ファイル）**:
- [ ] getPlayerContextをインポートしている
- [ ] 全カード効果が新パターンに変換されている
...
### Phase 1 完了チェック
- [ ] `getPlayerContext()` が effectHelpers.js に実装されている
- [ ] 全プロパティが正しくマッピングされている
- [ ] export されている

### Phase 2 完了チェック
- [ ] `_template.js` が新パターンに更新されている
- [ ] コメントで使用例が記載されている

### Phase 3 完了チェック（cardEffects/）
- [ ] fire.js 移行完了・動作確認OK
- [ ] water.js 移行完了・動作確認OK
- [ ] light.js 移行完了・動作確認OK
- [ ] dark.js 移行完了・動作確認OK
- [ ] primitive.js 移行完了・動作確認OK
- [ ] future.js 移行完了・動作確認OK
- [ ] neutral.js 移行完了・動作確認OK

### Phase 4 完了チェック（cardTriggers/）
- [ ] fireCards.js 移行完了・動作確認OK
- [ ] waterCards.js 移行完了・動作確認OK
- [ ] lightCards.js 移行完了・動作確認OK
- [ ] darkCards.js 移行完了・動作確認OK
- [ ] primitiveCards.js 移行完了・動作確認OK
- [ ] futureCards.js 移行完了・動作確認OK
- [ ] neutralCards.js 移行完了・動作確認OK
