...
|------------|------|------|--------------|------|
| HR | ホログラム | ×150.0 | 80パック（4箱） | 全カード対象・キラ加工 |
| SEC | シークレット | ×600.0 | 200パック | 別イラスト |
| ALT | オルタナティブ | ×1800.0 | 500パック | 完全別アート（世界観違い） |
| SP | スペシャル | ×5500.0 | 1,250パック | イベント・期間限定 |
| GR | ゴッドレア | ×27000.0 | 5,000パック | 禁忌カード専用・最高峰 |
